...
struct FringeAPICodableTests {
    ...
    func testFringePerformanceSpace() throws {
        try testEncodeDecodeEquates(value: FringePerformanceSpace(name: "Item", ageLimited: nil))
        try testEncodeDecodeEquates(value: FringePerformanceSpace(name: "New", ageLimited: true))
        try testEncodeDecodeEquates(value: FringePerformanceSpace(name: nil, ageLimited: false))
    }
