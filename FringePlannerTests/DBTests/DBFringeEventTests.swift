...
struct DBFringeEventTests: DBFringeModelTestProtocol {
    ...
    func testPredicateIdentifiesCorrectModels() throws {
        ...
        let mockDBModel2 = DBFringeEvent(title: "Different Event", artist: "Other Artist", country: "USA", descriptionTeaser: "Another teaser", code: "EVT456", ageCategory: "18+", eventDescription: "Another test event", festival: "Edinburgh Fringe", festivalId: "F2025", genre: "Theatre", genreTags: "drama,theatre", performances: [mockPerformance], performanceSpace: mockPerformanceSpace, status: .active, url: URL(string: "https://test2.com")!, venue: DBFringeVenue(code: "VEN456", name: "Another Venue", position: mockPosition, postCode: "EH2 2AB"), website: URL(string: "https://test2.com")!, disabled: nil, images: [:], warnings: nil, updated: mockEnd, year: 2025)
